...
public class KALEJointModel2 {
	public String matrixEPath;
	public String matrixRPath;
	...
	public void TransE_Learn() throws Exception {
		...
		BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(
				new FileOutputStream(logsPath), "UTF-8"));
...
//	###					weight
			...
			if (iIter % m_OutputIterSkip == 0) {
				...
				if (dCurrentMRR > dBestMRR) {
					m_Relation_Factor_MatrixR.output(matrixRPath);
					m_Entity_Factor_MatrixE.output(matrixEPath);
