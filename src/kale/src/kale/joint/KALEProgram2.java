...
public class KALEProgram2 {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			String matrixE = args[4];
			String matrixR = args[5];
			String logs = args[6];

			String ent = args[7];
			String rel = args[8];
			String dim = args[9];
			String mini_batch = args[10];
			String m_d = args[11];
			String m_gE = args[12];
			String m_gR = args[13];
			String iter = args[14];
			String skip = args[15];
			String m_weight = args[16];			
			...
			KALEJointModel2 transe = new KALEJointModel2();
